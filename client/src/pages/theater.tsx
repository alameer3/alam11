...
export default function Theater() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-900 to-orange-900 py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-4">المسرحيات</h1>
          <p className="text-center text-white/80 max-w-2xl mx-auto">
            اكتشف أجمل المسرحيات العربية والعالمية
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-6">
          ...
          <form onSubmit={handleSearch} className="flex-1">
            <div className="relative">
              <Input
                type="text"
                placeholder="البحث في المسرحيات..."
                value={searchQuery}

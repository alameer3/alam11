    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-4">البرامج والكورسات</h1>
          <p className="text-center text-white/80 max-w-2xl mx-auto">
            اكتشف أحدث البرامج التعليمية والكورسات في مختلف المجالات
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-6">
          ...
          <form onSubmit={handleSearch} className="flex-1">
            <div className="relative">
              <Input
                type="text"
                placeholder="البحث في البرامج والكورسات..."
                value={searchQuery}

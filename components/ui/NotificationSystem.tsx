...
import { Bell, X, CheckCircle, AlertCircle, Info, Star, Heart, Download, Play } from 'lucide-react';

interface Notification {
  id: string;
  type: 'success' | 'error' | 'warning' | 'info' | 'favorite' | 'download' | 'new_content';
  title: string;
  message: string;
  timestamp: Date;
  read: boolean;
...
export default function NotificationSystem() {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      type: 'new_content',
      title: 'محتوى جديد',
      message: 'تم إضافة فيلم "المصفوفة" إلى المكتبة',
      timestamp: new Date(Date.now() - 1000 * 60 * 30), // 30 minutes ago
      read: false,
      action: {
        label: 'مشاهدة',
        url: '/movie/the-matrix'
      }
    },
    {
      id: '2',
      ...
      message: 'تم إضافة مسلسل "بريكينغ باد" إلى قائمة المفضلة',
    ...
    },
    {
      ...
      type: 'download',
      title: 'اكتمل التحميل',
      message: 'تم تحميل فيلم "البداية" بنجاح',
    ...
    },
    {
      ...
      message: 'مرحباً بك في منصة أكوام',
  ...
  return (
    <div className="relative">
      ...
      {/* Overlay لإغلاق الإشعارات عند النقر خارجها */}
      {showNotifications && (
        <div
